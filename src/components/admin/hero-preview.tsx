          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex bg-muted rounded-lg p-1">
                {(Object.keys(deviceDimensions) as PreviewDevice[]).map(
                  (deviceType) => {
          ...
          <div className="flex items-center justify-between text-xs text-muted-foreground">
            <div className="flex items-center gap-2">
              <Badge variant="secondary" className="text-xs">
                {device} • {currentDimensions.width} ×{" "}
            ...
            <div className="text-xs">Scaled to {Math.round(scale * 100)}%</div>
          </div>
        </CardHeader>
      )}
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-900 dark:to-slate-800">
          ...
          <div
            ...
            style={{
              ...
              width: device === "desktop" ? "100%" : currentDimensions.width,
              height: device === "desktop" ? "auto" : currentDimensions.height,
              maxWidth: device === "desktop" ? "none" : currentDimensions.width,
            }}
          >
            {/* Hero Section */}
            <section className="relative min-h-screen flex items-center py-16 overflow-hidden bg-gradient-to-br from-background via-background to-accent/20">
              ...
              >
                ...
                >
                  ...
                  <div className="rounded-full hover:bg-primary/10 transition-all duration-300 p-2">
